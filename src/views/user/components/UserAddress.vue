  ...
  <div class="app-container">
    ...
    <el-row>
      <div class="chart-container">
        <el-table v-loading="loading" ref="UserAddressTable" :data="data" border fit highlight-current-row style="width: 100%;" @sort-change="sortSignTime">
          <!-- 操作 -->
          ...
          <el-table-column type="index" align="center" width="50"/>
					<el-table-column prop="signerName" label="收件人" align="center"> </el-table-column>
					<el-table-column prop="signerMobile" label="电话" align="center"> </el-table-column>
          ...
          <el-table-column prop="addressDetail" label="详细地址" align="center">
					...
					<el-table-column prop="postalCode" label="邮编" align="center"> </el-table-column>
          <el-table-column prop="isDefault" label="默认地址" align="center">
            <template slot-scope="scope">
              <BooleanTag v-model="scope.row.isDefault"></BooleanTag>
            </template>
          </el-table-column>
    ...
    <!-- 对话框 -->
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="48%" top="7vh" append-to-body="true">
      <el-form ref="userAddressForm" :model="userAddressTemp" :rules="rules" class="form-add" label-width="100px" style="width: 100%; padding-left:10px;padding-right:10px">
        ...
        <el-form-item label="默认地址" prop="isDefault">
					<el-checkbox v-model="userAddressTemp.isDefault"></el-checkbox>
